...
export default defineConfig({
  mode: MODE,
  base: '/',
  assetsInclude: ['**/*.bcmap', '**/*.pfb', '**/*.ttf', '**/*.properties'],
  define: {
  ...
  resolve: {
    ...
    alias: {
      ...
      '@odoc/pdf-annotate-core': path.join(__dirname, 'src/pdf-annotate-core'),
      '@odoc/pdf-annotate-viewer': path.join(__dirname, 'src/pdf-annotate-viewer'),
      '@odoc/pdf-annotate-core/dist': path.join(__dirname, 'src/pdf-annotate-core'),
      '@odoc/pdf-annotate-viewer/dist': path.join(__dirname, 'src/pdf-annotate-viewer'),
