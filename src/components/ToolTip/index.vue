...
// import setAttributes from '@odoc/pdf-annotate-core/utils/setAttributes';
...
import { delay } from '@odoc/aiknowledge-special-util/delay';
import {
...
const showTool = ref({
  ai: true,
  highlight: true,
  translate: envStore.viewerConfig.toolTipTranslateIcon !== false && serviceOffStore.isServiceOn,
  comment: true,
});
