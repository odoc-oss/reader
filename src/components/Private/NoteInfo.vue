...
import { UserStatusEnum } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/note/OpenNote';
...
import {
  ReportType,
  UgcReportSubType,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/UgcReport';
