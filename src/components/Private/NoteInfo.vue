...
import { UserStatusEnum } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/note/OpenNote';
...
import {
  ReportType,
  UgcReportSubType,
} from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/UgcReport';
