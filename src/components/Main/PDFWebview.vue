...
import pdfjsWorkerSrc from '@odoc/pdfjs-dist/build/pdf.worker.js?url';

import PDFError from './PDFError.vue';
import { debounce } from 'lodash-es';
import PDFViewerThemeAddonInstance from '~/src/theme';
import { PDFViewerColorToneAddon } from '@odoc/pdf-annotate-viewer';
import reporter from '@odoc/aiknowledge-report';
    ...
    const pdfWebview = createPDFWebview(
      {
        pdfDocumentParams: {
          url: props.pdfUrl,
          cMapUrl:
            '/node_modules/@odoc/pdfjs-dist/cmaps/',
          retryUrl: getPDFRetryUrl(props.pdfUrl),
          language: (() => {
