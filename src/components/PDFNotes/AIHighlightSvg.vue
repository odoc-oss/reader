...
import { SCIMItem } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/scim/AiSCIMInfo';
import { ViewerController } from '@odoc/pdf-annotate-viewer';
import { Rectangle } from '@odoc/pdf-annotate-core/render/renderSelect';
