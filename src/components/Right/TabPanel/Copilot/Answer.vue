...
// import { MarkdownViewer } from '@odoc/aiknowledge-markdown';
...
import { Satisfaction } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/AiAssistReading'
