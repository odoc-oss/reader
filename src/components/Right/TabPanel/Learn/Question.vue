...
import { mdi } from '@odoc/aiknowledge-markdown';
import { FastReadingQuestionInfo } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/paper/PaperDetail';
...
import { IdeaMarkdown } from '@odoc/aiknowledge-markdown';
import '@odoc/aiknowledge-markdown/dist/style.css';
