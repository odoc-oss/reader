...
import { RectOptions } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/notev2/Common';

import type { PromiseType, ValuesType } from 'utility-types';
import type PDFPageView from '@odoc/pdf-annotate-viewer/typing/PDFPageView';
import type WordMatchController from '@odoc/pdf-annotate-viewer/typing/WordMatchController';
import { ViewerEvent } from '@odoc/pdf-annotate-viewer';
import {
  PDF_ANNOTATIONLAYER,
...
} from '@odoc/pdf-annotate-core';
import { Annotation } from '@odoc/pdf-annotate-core/render/appendChild';
