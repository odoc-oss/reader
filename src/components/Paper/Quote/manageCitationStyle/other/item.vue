<template>
  <div class="other-style-item-wrap">
    ...
    <div
      ...
      @click="handleClick"
    >
      <MinusOutlined v-if="data.addedFlag" />
      <i v-else class="aiknowledge-icon icon-add" aria-hidden="true"></i>
    </div>
  </div>
</template>
<script lang="ts">
import { defineComponent, PropType } from 'vue'
import { CslItem } from 'go-sea-proto/gen/ts/doc/CSL'
import { message } from 'ant-design-vue'
import { addCsl, deleteCsl } from '@/api/citation'
