...
import { UserDocClassifyInfo } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/userCenter/UserDoc'
import { UserDocInfo } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/doc/UserDocManage'
