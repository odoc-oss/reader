<template>
  <div class="workbench-container">
    ...
    <div class="sidebar" :class="{ 'collapsed': isSidebarCollapsed }">
      ...
      <div v-if="isTauriMode()" class="sidebar-item" :class="{ 'active': currentPath === '/workbench/importdata' }" @click="router.push('/workbench/importdata')">
        <setting-outlined />
        <span v-show="!isSidebarCollapsed">{{ t('workbench.importData') }}</span>
      </div>
...
import { isTauriMode } from '@/util/env';
