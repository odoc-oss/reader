import { PageSelectText, ViewerController } from '@odoc/pdf-annotate-viewer';
import { WordInfo } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/notev2/NoteModule';
import { useCommentGlobalState } from '../useNoteState';
import { styleMap } from '@/style/select';
import { ToolBarType, scaleDownRaw } from '@odoc/pdf-annotate-core';
import { SelectAnnotation } from '@odoc/pdf-annotate-core/render/renderSelect';
