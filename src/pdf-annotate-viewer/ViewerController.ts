import * as pdfjsViewer from '@odoc/pdfjs-dist/web/pdf_viewer'
import * as pdfjsLib from '@odoc/pdfjs-dist'
import {
  PDFDocumentLoadingTask,
  DocumentInitParameters,
} from '@odoc/pdfjs-dist/types/src/display/api'
import {
  LoadingBem,
  LoadingProgressBem,
  LoadingSVG,
...
import { PDFRenderingQueue as PDFRenderingQueueType } from '@odoc/pdfjs-dist/types/web/pdf_rendering_queue'
import ScrollController from './ScrollController'
import FinderViewer from './FinderViewer'
import hotkeys from 'hotkeys-js'
import DownloadController from './DownloadController'
import SANDBOX_BUNDLE_SRC from '@odoc/pdfjs-dist/build/pdf.sandbox.js?url'
import { createL10nController } from './L10nController'
import { PDFViewerOptions as BasePDFViewerOptions } from '@odoc/pdfjs-dist/types/web/pdf_viewer'
...
export class ViewerController {
  ...
  private _createLoadingTask(
    ...
    const loadingTask = pdfjsLib.getDocument({
      cMapUrl: '/node_modules/@odoc/pdfjs-dist/cmaps/',
      cMapPacked: true,
      enableXfa: true,
      isEvalSupported: false,
      standardFontDataUrl:
        '/node_modules/@odoc/pdfjs-dist/standard_fonts/',
      ...pdfDocumentParams,
    })
  ...
  async build(scale: PDFViewerScale, pdfOptions: PDFViewerOptions) {
    ...
    const documentViewer = new DocumentViewer(
      ...
      },
      {
        ...
        imageResourcesPath:
          '/node_modules/@odoc/pdfjs-dist/web/images/',
        ...pdfOptions,
      }
    )
