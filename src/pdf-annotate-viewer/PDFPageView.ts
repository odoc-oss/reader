...
import { TextLayerBuilderOptions } from '@odoc/pdfjs-dist/types/web/text_layer_builder'
import { TextHighlighterOptions } from '@odoc/pdfjs-dist/types/web/text_highlighter';
