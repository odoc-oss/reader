import { TextContent, TextItem, TextMarkedContent } from "@odoc/pdfjs-dist/types/src/display/api";
import { PageViewport } from "@odoc/pdfjs-dist/types/src/display/display_utils";
import * as SharedUtil from "@odoc/pdfjs-dist/lib/shared/util";
import { TextContentBound, TextContentChar } from "./type";
import { getTextProperties } from "./utils/text";
import { TextLayerRenderParameters } from '@odoc/pdfjs-dist/types/src/display/text_layer'
