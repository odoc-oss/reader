import { PDFPageProxy } from '@odoc/pdfjs-dist/types/src/display/api'
import cbem from './css/style'
// import * as WebUiUtils from '@odoc/pdfjs-dist/lib/web/ui_utils'
import { OptionalContentConfig, PDFRenderingQueue } from '@odoc/pdfjs-dist/types/web/pdf_page_view'
import { PageViewport } from '@odoc/pdfjs-dist/types/src/display/display_utils'
