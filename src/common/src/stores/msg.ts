...
import {
  DetailMessageCount,
  MessageTypeEnum,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/operator/admin/msg/SystemMsgInfo';
import useSharedWebsocket from '@common/hooks/useSharedWebsocket';
import { getRedDotConfig, getRedDotInfo } from '~/src/api/user';
import { watch } from 'vue';
import { FunctionTypeEnum } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/RedDot';
