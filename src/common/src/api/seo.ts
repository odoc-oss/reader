...
import {
  GetTDKReq,
  GetTDKResp,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/seo/SEOTdkInfo';
import { SeoPageType } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/seo/SEOCommon';
