...
import {
  GetTDKReq,
  GetTDKResp,
} from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/seo/SEOTdkInfo';
import { SeoPageType } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/seo/SEOCommon';
