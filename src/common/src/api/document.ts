import { normalizeAssign } from '@odoc/aiknowledge-special-util';
import {
...
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/client/ClientDoc';
import {
  GetAuthorsRequest,
  GetAuthorsResponse,
  ...
  UpdateVenueRequest,
  UpdateVenueResponse,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/doc/UserDoc';
import {
  GetDocIndexReq,
  GetDocIndexResponse,
  GetDocListReq,
  ...
  UserDocInfo,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/doc/UserDocManage';
import {
...
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/userCenter/UserDoc';
import {
  ExportByFolderIdReq,
  ExportByIdsReq,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/doc/bibtex/BibtexInfo';
