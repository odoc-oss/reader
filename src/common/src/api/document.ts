...
} from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/client/ClientDoc';
import {
  GetAuthorsRequest,
  GetAuthorsResponse,
  ...
  UpdateVenueRequest,
  UpdateVenueResponse,
} from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/doc/UserDoc';
import {
  GetDocIndexReq,
  GetDocIndexResponse,
  GetDocListReq,
  ...
  UserDocInfo,
} from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/doc/UserDocManage';
import {
...
} from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/userCenter/UserDoc';
import {
  ExportByFolderIdReq,
  ExportByIdsReq,
} from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/doc/bibtex/BibtexInfo';
