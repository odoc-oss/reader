...
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiAssistantReading/ReadingFeedbackInfo';
import { RefundAiBeanReq as RefundAiBeanPolishReq } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/polish/PolishFeedbackInfo';
