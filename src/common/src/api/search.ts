...
import {
  ...
  AutoCpResponse,
  CpPaperInfo,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/search/AutoCP';
import { api } from './axios';
import {
  UserCenterSearchRequest,
  UserCenterSearchResponse,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/search/SearchNote';
import { SearchResponse } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/doc/UserDoc';

import { DocDetailInfo } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/client/ClientDoc';
import { FOSAdministrator } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/fieldOfStudy/FieldOfStudyDetail';
