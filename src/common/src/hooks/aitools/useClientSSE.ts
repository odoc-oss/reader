import { TranslateSentence } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/AiPolishText';
...
declare module '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/AiPolishText' {
