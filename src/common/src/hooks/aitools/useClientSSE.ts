import { TranslateSentence } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/AiPolishText';
...
declare module '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/AiPolishText' {
