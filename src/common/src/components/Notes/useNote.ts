...
import { SortTypeEnum } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/protocol/note/request/_GetMyNoteMarkListReq';
// import { GetAnnotateTagsResp } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/notev2/Tag';
