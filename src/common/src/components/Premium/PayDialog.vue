...
import {
  VipRole,
  VipType,
} from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/user/VipUserInterface'
import { GetScanQRCodeResp, VipPayType, GroupBuyItem } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/vip/VipPayInfo'
import {
  getPayOrigin,
  getQrCodeParams,
