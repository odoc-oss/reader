import { MessageTypeEnum } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/operator/admin/msg/SystemMsgInfo';
...
import { IsDisplayVipAdjustContentResponse } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/MessageCenter';
import {
  GetUserRedDotListResponse,
  ClearRedDotReq,
} from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/RedDot';

import { User } from 'go-sea-proto/gen/ts/user/User'
import { GetMyStatisticalReps } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/homePage/StatisticalInformation'

// import { GetTrafficReq, GetTrafficResp } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/ab/ABTestInfo';
