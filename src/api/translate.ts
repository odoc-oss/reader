...
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/translate/v1/TencentTranslateProto';
import {
  IdeaTranslateReq,
  IdeaTranslateResp,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/translate/IdeaTranslateProto';
import { TranslateCorrectInfoReq } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/translate/TranslateCorrectInfoProto';
import {
  GoogleClientEnableReq,
  GoogleClientEnableResp,
  GoogleTranslateReq,
  GoogleTranslateResp,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/translate/GoogleTranslateProto';
import {
  GetTranslateTabListResp,
  OcrTranslateReq,
  TranslateReq,
  TranslateResp,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/translate/TranslateProto';
import {
  AddInterfaceReq,
  ...
  GoogleConfig,
  DeepLConfig,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/translate/CustomTranslateInterface';
