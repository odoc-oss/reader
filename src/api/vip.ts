...
import { VipProfileResponse } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/user/VipUserInterface';
import { GetActivitiesStatusResp } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/vip/VipActivitiesInfo';
import {
  OcrRemainCountReq,
