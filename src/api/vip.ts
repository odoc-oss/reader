...
import { VipProfileResponse } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/user/VipUserInterface';
import { GetActivitiesStatusResp } from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/vip/VipActivitiesInfo';
import {
  OcrRemainCountReq,
