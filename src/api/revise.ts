import {
  ...
  ApplyQuotaReq,
  ApplyQuotaResp,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/AiPolishText';
import {
  TagsRequest,
  TagsResponse,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/AiPolishPdf';
import {
  TrialCountResponse,
  TrialIsEnabledReq,
  TrialIsEnabledResponse,
} from '@odoc/types-go-sea-proto/types/cn/edu/idea/cloud/polish/TrialCount';
