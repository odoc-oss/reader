import {
  ...
  ApplyQuotaReq,
  ApplyQuotaResp,
} from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/AiPolishText';
import {
  TagsRequest,
  TagsResponse,
} from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/AiPolishPdf';
import {
  TrialCountResponse,
  TrialIsEnabledReq,
  TrialIsEnabledResponse,
} from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/polish/TrialCount';
