...
import {
  ...
  AutoCpResponse,
  CpPaperInfo,
} from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/search/AutoCP';
import { api } from './axios';
import {
  UserCenterSearchRequest,
  UserCenterSearchResponse,
} from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/search/SearchNote';
import { SearchResponse } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/doc/UserDoc';

import { DocDetailInfo } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/client/ClientDoc';
import { FOSAdministrator } from '@idea/types-go-sea-proto/types/cn/edu/idea/cloud/aiKnowledge/fieldOfStudy/FieldOfStudyDetail';
